...
$(document).ready(function (event) {
  ...
  $('#camper_make').click(function (event) {
    sort(event);
  });
  $('#camper_brand').click(function (event) {
    sort(event);
  });
  $('#sleep_number').click(function (event) {
    sort(event);
  });
...
function arrowManager(event) {
  $('#searchTerm').val('');
  var currentDirection = event.currentTarget.className;
  resetArrows();
  var nextDirection = '';
...
function sort(event) {
  var sortColumn = event.currentTarget.id;
  var direction = arrowManager(event);
  $.ajax({
    url: "/api/search",
    type: "GET",
    data: {
    ...
    success: function success(result) {
      ...
      for (var _i2 = 0, _Object$entries2 = Object.entries(result.data); _i2 < _Object$entries2.length; _i2++) {
...
function search() {
  $.ajax({
    ...
    success: function success(result) {
      ...
      for (var _i3 = 0, _Object$entries3 = Object.entries(result.data); _i3 < _Object$entries3.length; _i3++) {
